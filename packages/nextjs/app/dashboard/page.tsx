...
const CourseCard = ({ title, description, image, category }: any) => (
  <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-transform transform hover:-translate-y-2">
    <div className="h-48 bg-cover bg-center relative" style={{ backgroundImage: image }}>
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-white">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <div className="flex justify-center mb-8 space-x-4">
          {["All", "Beginner", "Intermediate", "Advanced", "Security"].map(category => (
            <button
              key={category}
              className="px-4 py-2 text-sm font-semibold rounded-full border hover:bg-blue-600 hover:text-white transition-all"
            >
              {category}
            </button>
          ))}
