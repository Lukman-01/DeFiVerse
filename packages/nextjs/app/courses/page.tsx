      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore our curated courses designed to take you from DeFi basics to
            advanced concepts. Each course is crafted by industry experts to
            provide you with practical knowledge.
          </p>
        </div>
