...
import { Copy, Server, DollarSign, AlertTriangle, ChevronDown, ArrowRight} from 'lucide-react';
  ...
  const attackScenarios: AttackScenario[] = [
    {
      ...
      description: "An attacker attempts to spend the same funds multiple times by creating a parallel chain and convincing recipients that a transaction was confirmed.",
      consequences: [
    ...
    },
    {
      ...
      description: "Miners withhold discovered blocks to gain an unfair advantage, potentially forcing other miners to waste computational power on already-solved blocks.",
      consequences: [
    ...
    },
    {
      ...
      description: "Attackers offer financial incentives to miners to reorganize the blockchain or include specific transactions, undermining network security.",
      consequences: [
    ...
    <div className="max-w-4xl mx-auto p-6 bg-gray-50">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          The blockchain layer manages consensus and incentive mechanisms, making it
          crucial for network security and stability. Various attack vectors target
          these mechanisms to undermine network integrity.
        </p>
      </div>
      ...
      <div className="mt-8 p-4 bg-yellow-50 rounded-lg">
        <div className="flex items-center space-x-2">
          ...
          <p className="text-sm text-yellow-800">
            Blockchain layer attacks can severely impact network security and
            require significant mining power or financial resources to execute.
            Proper monitoring and defensive measures are essential.
          </p>
        </div>
      </div>
    </div>
