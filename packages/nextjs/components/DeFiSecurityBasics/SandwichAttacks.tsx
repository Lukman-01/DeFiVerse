...
import { ArrowBigUp, ArrowBigDown, AlertCircle, Shield } from 'lucide-react';
...
const StepCard = ({ title, description, icon: Icon, active }: {
  title: string;
  description: string;
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      <div className="bg-gradient-to-r from-purple-600 to-purple-800 p-8 rounded-xl text-white">
        ...
        <p className="text-lg opacity-90">
          Advanced MEV exploitation targeting AMM price slippage
        </p>
      </div>
