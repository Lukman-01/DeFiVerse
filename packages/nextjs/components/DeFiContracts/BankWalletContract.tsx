...
import { Code, LightbulbIcon, ShieldCheck, Wallet } from "lucide-react";
        ...
        <CardContent className="space-y-4 pt-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            <p className="text-blue-800">
              Think of a smart contract wallet as your personal digital bank account with superpowers! Just like a
              regular bank account lets you store money and set spending limits, this digital wallet lets you do all
              that and more. You can set daily spending limits, authorize other people to spend on your behalf (like
              giving someone a debit card), and keep your funds secure with automatic safety features.
            </p>
          </div>
        ...
        <CardContent className="space-y-6 pt-4">
          <div className="grid gap-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-gray-600">Each account keeps track of:</p>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-gray-600">The wallet lets you:</p>
              <ul className="list-disc pl-6 mt-2 space-y-1 text-gray-600">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-gray-600">You can safely share your wallet by:</p>
              <ul className="list-disc pl-6 mt-2 space-y-1 text-gray-600">
