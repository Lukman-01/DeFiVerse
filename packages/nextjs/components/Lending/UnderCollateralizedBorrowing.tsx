...
import { ArrowRight, BarChart, Lock, TrendingUp, Wallet } from "lucide-react";
      ...
      <div className="bg-white rounded-lg shadow-lg">
        <div className="p-6 border-b">
          ...
          <p className="mt-4 text-gray-600">
            Under-collateralized borrowing enables users to borrow more than their collateral value, but with restricted
            usage through pre-designed smart contracts, typically for farming strategies.
          </p>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="mb-8 p-4 bg-blue-50 rounded-lg">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium mb-2">Leverage Multiplier (1x - 6x)</label>
                <input
                  type="range"
                  min="1"
                  max="6"
              ...
              <div className="p-4 bg-white rounded-lg">
                ...
                <ul className="mt-2 space-y-1 text-sm">
                  <li>
                    • ${1000} deposit → ${1000 * multiplier} position size
                  </li>
