...
import { AlertTriangle, Info, Shield, TrendingDown, TrendingUp } from "lucide-react";
  ...
  return (
    <div className={`p-4 rounded-lg border ${className}`}>
      ...
      <div className="flex items-center gap-2">
        <div
          className={`h-3 flex-grow rounded-full ${getHealthColor(value)}`}
  ...
  const terms: Term[] = [
    {
      ...
      details: {
        explanation:
          "Collateral is the backbone of DeFi lending, providing security for loans through smart contracts.",
        examples: [
    ...
    },
    {
      ...
      details: {
        ...
        examples: ["Flash loans", "Protocol-specific farming", "Restricted usage loans"],
        riskLevel: "high",
      },
    },
    {
        ...
        {selectedTerm && (
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            <div className="flex items-start gap-2">
              ...
              <div>
                <h4 className="font-semibold mb-2">{terms.find(t => t.id === selectedTerm)?.title} Explained</h4>
                <p className="text-gray-600 mb-4">{terms.find(t => t.id === selectedTerm)?.details.explanation}</p>
                <div className="space-y-2">
                  <h5 className="font-medium">Examples:</h5>
                  <ul className="list-disc pl-5 space-y-1">
                    {terms
                      .find(t => t.id === selectedTerm)
