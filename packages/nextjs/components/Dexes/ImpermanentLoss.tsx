...
import { AlertTriangle, Calculator, DollarSign, Info, TrendingUp } from "lucide-react";
      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={generateChartData()}>
            ...
            <XAxis dataKey="price" label={{ value: "ETH Price (DAI)", position: "bottom" }} />
            <YAxis label={{ value: "Impermanent Loss (%)", angle: -90, position: "insideLeft" }} />
            <Tooltip />
            <Line type="monotone" dataKey="impermanentLoss" stroke="#2563eb" dot={false} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 bg-white rounded-lg shadow">
          ...
          <p className="text-sm text-gray-600">
            1 ETH = 100 DAI Pool Share: 10% Assets: 1 ETH + 100 DAI Value: 200 USD
          </p>
        </div>
        <div className="p-4 bg-white rounded-lg shadow">
          <h4 className="font-medium mb-2">Price Change</h4>
          <p className="text-sm text-gray-600">1 ETH = 400 DAI Arbitrage occurs Assets rebalanced</p>
        </div>
        <div className="p-4 bg-white rounded-lg shadow">
          <h4 className="font-medium mb-2">Final State</h4>
          <p className="text-sm text-gray-600">0.5 ETH + 200 DAI Value: 400 USD IL Loss: 100 USD vs. HODL</p>
        </div>
      </div>
    </div>
  );
        ...
        <div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <p className="text-gray-600">
              Impermanent loss occurs when the value of assets provided to a liquidity pool changes relative to their
              value if held outside the pool. The loss becomes permanent only when liquidity is withdrawn from the pool.
            </p>
          </div>
        </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-yellow-700 mt-1">
                Impermanent loss can result in total loss of funds. Trading fees and liquidity mining rewards may help
                offset losses, but risks remain significant during high volatility periods.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {calculatedLoss !== null && (
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <div className="text-3xl font-bold text-blue-600">{calculatedLoss.toFixed(2)}% Loss</div>
