...
import { DollarSign, AlertTriangle, ArrowUpDown, Activity } from 'lucide-react';
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg max-w-4xl mx-auto">
      ...
      <div className="mb-8 text-gray-600">
        <p>
          Specialized decentralized exchanges designed to facilitate efficient trading of
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {features.map((feature) => (
            <div 
              key={feature.id}
              className="p-4 bg-blue-50 rounded-lg transition-all hover:shadow-md"
            >
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {challenges.map((challenge) => (
            <div 
              key={challenge.id}
              className="p-4 bg-red-50 rounded-lg transition-all hover:shadow-md"
            >
              <div className="flex items-center mb-2">
