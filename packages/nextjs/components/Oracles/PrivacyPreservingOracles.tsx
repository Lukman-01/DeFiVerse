...
import { Banknote, DatabaseIcon, ExternalLink, Home, LockKeyhole, Shield, UserCheck } from "lucide-react";
  ...
  const applications = [
    {
      ...
      benefits: ["Private property valuation", "Confidential asset verification", "Secure ownership proof"],
      example: {
    ...
    },
    {
      ...
      benefits: ["Private lending positions", "Confidential trading history", "Protected collateral data"],
      example: {
    ...
    },
    {
      ...
      benefits: ["Selective attribute disclosure", "Privacy-preserving KYC", "Credential verification"],
      example: {
    ...
    <div className="p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 text-lg">
          Privacy-preserving oracles expand the possibilities of DeFi by enabling applications that require sensitive or
          personal data without compromising user privacy.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {applications.map((app, index) => (
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-blue-50 rounded-lg">{app.icon}</div>
      ...
      <div className="bg-gray-50 rounded-lg p-6">
        <h3 className="text-xl font-semibold mb-6">{applications[activeExample].example.title} Example</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-4 text-center">Interactive visualization coming soon</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 p-4 bg-blue-50 rounded-lg">
        ...
        <p className="text-sm text-gray-600">
          Explore technical documentation and implementation guides for integrating privacy-preserving oracles into your
          DeFi applications.
        </p>
      </div>
    </div>
