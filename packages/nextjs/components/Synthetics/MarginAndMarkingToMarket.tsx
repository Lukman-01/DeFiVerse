...
const MarginAndMarkingToMarket = () => {
  ...
  const [tradingData] = useState([
    { day: 0, price: 5.10, profit: 0, balance: 5000 },
    { day: 1, price: 5.20, profit: 500, balance: 5500 },
      ...
      return (
        <div className="flex items-center p-4 mt-4 bg-red-50 border border-red-200 rounded-lg">
          ...
          <span className="text-red-700">
            Margin Call! Account balance below maintenance margin requirement.
          </span>
        </div>
      );
    }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-2xl font-bold text-blue-700">
              {contractSize.toLocaleString()} oz
            </p>
          </div>
          ...
          <div className="p-4 bg-purple-50 rounded-lg">
            ...
            <p className="text-2xl font-bold text-purple-700">
              ${maintenanceMargin.toLocaleString()}
            </p>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="h-64">
            ...
            >
              ...
              <YAxis yAxisId="right" orientation="right" label={{ value: 'Balance ($)', angle: 90, position: 'insideRight' }} />
              <Tooltip />
              <Legend />
              <Line
                yAxisId="left"
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {tradingData.map((day) => (
                  <tr key={day.day}>
                    ...
                    <td className={`px-6 py-4 whitespace-nowrap ${day.profit > 0 ? 'text-green-600' : day.profit < 0 ? 'text-red-600' : ''}`}>
        ...
        <div className="mt-8 p-6 bg-gray-50 rounded-lg">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-600">Set by the exchange based on asset volatility. This is the minimum deposit required to open a position.</p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900">Maintenance Margin</h4>
              <p className="text-gray-600">If account value falls below this threshold, a margin call is triggered requiring additional deposits.</p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900">Mark-to-Market</h4>
              <p className="text-gray-600">Daily process of adjusting the account value based on current market prices, ensuring transparency and risk management.</p>
            </div>
          </div>
        </div>
