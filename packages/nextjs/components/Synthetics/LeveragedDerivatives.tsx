...
import { AlertTriangle, ArrowUpRight, DollarSign, Lock, TrendingUp } from "lucide-react";
    ...
    <div className="p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Advanced financial instruments that amplify market exposure through borrowed capital, enabling traders to
          control larger positions with smaller capital requirements.
        </p>
      </div>
