...
import { BookOpen, ChevronRight, Coins, Globe, Lock, TrendingUp, Users, Zap } from "lucide-react";
...
const BenefitCard = ({ icon, title, description, stats }: any) => (
  <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
    ...
    {stats && <div className="bg-blue-50 rounded-lg p-3 text-sm text-blue-800">{stats}</div>}
  </div>
);
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-6 border-b bg-gradient-to-r from-blue-500 to-purple-500 text-white">
          ...
          <p className="mt-4 text-lg">
            Decentralized Finance is revolutionizing the financial world, offering unprecedented opportunities for
            financial innovation, inclusion, and sovereignty. Understanding DeFi is becoming essential for anyone
            ...
            {["benefits", "learning"].map(tab => (
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-colors
                  ${activeTab === tab ? "bg-blue-500 text-white" : "bg-gray-100 hover:bg-gray-200 text-gray-700"}`}
              >
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <div className="mt-8 p-4 bg-yellow-50 rounded-lg">
                ...
                <p className="text-yellow-700">
                  Start with small amounts when experimenting with DeFi protocols. Always research thoroughly and
                  understand the risks before committing significant resources.
                </p>
              </div>
            </div>
          )}
