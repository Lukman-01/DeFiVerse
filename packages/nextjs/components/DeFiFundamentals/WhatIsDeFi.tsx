...
import { AlertTriangle, ArrowRightLeft, Banknote, Building2, ChevronRight, Coins, ShieldCheck } from "lucide-react";
...
const DeFiEducationalInterface = () => {
  ...
  return (
    <div className="mspace-y-8 p-4">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-6 border-b">
          <h1 className="text-2xl font-bold">Understanding DeFi: The Future of Finance</h1>
          <p className="mt-4 text-lg text-gray-600">
            Decentralized Finance (DeFi) represents a paradigm shift in financial services, leveraging blockchain
            technology to create an open, permissionless, and transparent financial system.
          </p>
        </div>
        ...
        <div className="p-6">
          <div className="flex space-x-4 mb-6">
            ...
            <TabButton isActive={activeTab === "risks"} onClick={() => setActiveTab("risks")}>
              Risks
            </TabButton>
          </div>
